...
## 2- Tests sur le fichier `cisi.txt`

print('\n\n\n*** Parsing du fichier `cisi.txt` en cours ... ***')
p = parser.Parser('data/cisi/cisi.txt')            # parsing
...
input('\nLes TFs du document 2450 de `cisi.txt`, presser \'Entrée\':\n')
print(i.getTfsForDoc(2450))
input('\n\nLes TF-IDFs du document 2450 de `cisi.txt`, presser \'Entrée\':\n')
print(i.getTfIDFsForDoc(2450))
input('\n\nLes TFs du stem \'crimin\' dans `cisi.txt`, presser \'Entrée\':\n')
print(i.getTfsForStem('crimin'))
input('\n\nLes TF-IDFs du stem \'crimin\' dans `cisi.txt`, presser \'Entrée\':\n')
print(i.getTfIDFsForStem('crimin'))

# Affichage du texte du document d'identifiant 4203
input('\n\nTexte du document d\'identifiant 2450 dans `cisi.txt`, presser \'Entrée\':\n')
print(i.getStrDoc(2450))


# ------------------------------ Test requêtes ------------------------------

print('\n\n*** Lecture des requêtes en cours ... ***')
qp = query.QueryParser('data/cisi/cisi.qry', 'data/cisi/cisi.rel')

input('\n20e requête de `cisi.qry`, presser \'Entrée\':\n')
